 ...
 function listOfNames(array) {
   let artistsNames = [...array];{
    for(let i = 0; i < array.length; i++)
      artistsNames[i] = artistsNames[i].name;
    }
   return artistsNames
 }
...
function removeArtist(array, index) {
    let onelessArtist = [...array];
    onelessArtist.splice(index, 1)
    return onelessArtist
    }
...
function addArtist(array, string1, string2, string3, string4, string5) {
  let Artists2 = [...array];
  let newArtist = {name: string1,
  years: string2,
  genre: string3,
  nationality: string4,
  bio: string5
  }
  Artists2.push(newArtist)
return Artists2
}
...
console.log('task 8:', artistInfo(artists, 'Andrei Rublev'))
